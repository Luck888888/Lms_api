...
class GetUsersExportRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        $allowed_file_format =  get_allowed_file_format(true);
        ...
        return [
            ...
            'file_format'             => 'sometimes|string:' . $allowed_file_format,
        ];
    }
    ...
    /**
     * @return \Modules\Users\Dto\UserExportDto
     */
    public function getUserExportDto(): UserExportDto
    {
        $data = $this->validated();
        $data['user'] = auth()->user();
        return new UserExportDto($data);
    }
}
